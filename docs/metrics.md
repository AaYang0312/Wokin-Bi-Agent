...
推导（同步成功、档案存在、上游回空均不算证据；`quality_rule` 过期视同未核验）。三种缺口
分开归因，不得互相冒充：

| 情况 | 结果 | 恢复策略 |
| --- | --- | --- |
| 平台未登记来源 | `source_unconfigured` →「N 家店铺的来源尚未开通」 | 0 次追加：重跑不会开通来源 |
...
> 未定事项：2026-09-11 拼多多的 46/46 无金额样本未亪标明出自哪个通道。逐店开启
